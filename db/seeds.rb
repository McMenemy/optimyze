...
Optimization.create!(
  ...
  description: 'T25 is a beachbody.com 60-day workout video series that uses high-interval, high-intensity exercises to get an hours worth of exercise in 25 minutes. The early videos require no equipment and later videos use light dumbbells. Different videos focus on working different muscle groups and get progressively more difficult. See the details here: https://www.beachbody.com/product/fitness_programs/focus-t25-workout.do . Also, saves time on not having to drive to gym. Investment time is just ordering the videos online. The series cost about $100, which is not too bad when you compare that to the cost of a gym membership.',
...
Optimization.create!(
  title: 'Soylent',
  description: 'Soylent comes in either a bottle or powder form and was created by engineers to have everything the body needs. Don\'t waste time deciding what to eat or prepping food again! (For those not willing to switch every meal to Soylent you can also just use it as needed for a quick ToGo meal. https://www.soylent.com/ (Comes out roughly $3 a meal.)',
  investment_time: '0',
...
Optimization.create!(
  ...
  description: 'The sleep gained from snoozing is not good quality, so you might as well get moving quickly =)',
  investment_time: '0',
...
Optimization.create!(
  ...
  description: 'For those of you who want to save time by not snoozing, but can\'t muster up the willpower in the morning; there are apps that make you pay money to charities every time you hit snooze. (If thats not enough you can even set it up to make you pay money to organizations you don\'t like...). Here\'s a link to one app there are many out there: http://www.theguardian.com/voluntary-sector-network/2014/oct/29/-sp-snooze-button-app-charity-donation-icukoo , Investment time is the 5-10 minutes it takes to find and download the app to your phone',
...
Optimization.create!(
  ...
  description: 'Using Amazon subscriptions you can have most household and toiletry items delivered to you at any set time interval you desire (with prime shipping this is also free.) So, instead of spending 20 minutes every time you go to the store to find these items you can just have them always show up at door. Investment time is just the 30 minutes it takes to find all your items on amazon and set up the subscriptions',
  investment_time: '1800000',
...
Optimization.create!(
  ...
  description: 'Instead of walking use one of those self-balancing two-wheeled boards: https://en.wikipedia.org/wiki/Self-balancing_two-wheeled_board . To estimate the time saved I looked up the speed of the boards which is 6-10mph so easily twice as fast as a person walks. The average American walks 40 minutes a day so on average a person would save 20 minutes a day!',
  investment_time: '600000',
  time_saved_per_occurrence: '1200000',
  frequency: '86400000',
  user_id: '1'
...
Optimization.create!(
  ...
  description: 'Don\t waste time tying your shoes - just always wear loafers =). Only requires the investment time of buying a pair of loafers',
  investment_time: '600000',
